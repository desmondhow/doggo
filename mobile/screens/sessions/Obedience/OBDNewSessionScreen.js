          ...
          <View style={{ marginTop: 20 }}>
            <View style={{ flexDirection: "row", marginBottom: 20 }}>
              ...
              <Text style={{ fontSize: 22 }}>
                {this.state.addedDogs[dogNumber].handler}{" "}
              </Text>
              <Text
                style={{ marginLeft: 30, fontSize: 22, fontWeight: "bold" }}
              >
              ...
              >
                {this.state.addedDogs[dogNumber].familiar}
              </Text>
            </View>
            <View style={center}>
              <Divider
  ...
  _renderDogFields = (dogNumber, userIsAddingDog = false) => (
    ...
    >
      ...
      {renderReduxDropdown(
        ...
        userIsAddingDog
          ? null
          : dogName => this._updateDogState(dogNumber, "dogName", dogName),
        userIsAddingDog ? null : this.state.addedDogs[dogNumber].dogName
      )}
      {/* Handler */}
      ...
      {renderReduxDropdown(
        ...
        userIsAddingDog
          ? null
          : handlerName =>
              this._updateDogState(dogNumber, "handlerName", handlerName),
        userIsAddingDog ? null : this.state.addedDogs[dogNumber].handlerName
      )}
      {/* Familiar */}
            ...
            <ButtonGroup
              onPress={
                userIsAddingDog
                  ...
                  : isFamiliar =>
                      this._updateDogState(dogNumber, "isFamiliar", isFamiliar)
              }
              selectedIndex={
                userIsAddingDog
