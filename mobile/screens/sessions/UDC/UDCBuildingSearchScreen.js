        ...
        return (
            <View style={{
                ...
                <View>
                    ...
                    <Field name={`Performance.${sectionId}.barks`} component={inputProps => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <TextInput
                                style={styles.input}
                ...
                <View>
                    <Field name={`Performance.${sectionId}.handlerKnows`} component={(inputProps) => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <ButtonGroup
                                onPress={onChange}
                ...
                <Text h4>Fringe</Text>
                <View>
                    <Field name={`Performance.${sectionId}.fringe`} component={(inputProps) => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <ButtonGroup
                                onPress={onChange}
                ...
                <Text h4>Reset</Text>
                <View>
                    <Field name={`Performance.${sectionId}.reset`} component={(inputProps) => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <ButtonGroup
                                onPress={onChange}
                ...
                <View>
                    <Field name={`Performance.${sectionId}.falseAlert`} component={(inputProps) => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <ButtonGroup
                                onPress={onChange}
                ...
                <View>
                    <Field name={`Performance.${sectionId}.lead`} component={(inputProps) => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <ButtonGroup
                                onPress={onChange}
                ...
                <View>
                    <Field name={`Performance.${sectionId}.falseIndication`} component={(inputProps) => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <ButtonGroup
                                onPress={onChange}
                ...
                <View>
                    <Field name={`Performance.${sectionId}.detailSearch`} component={(inputProps) => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <ButtonGroup
                                onPress={onChange}
                ...
                <View>
                    <Field name={`Performance.${sectionId}.successful`} component={(inputProps) => {
                        const {input: {value, onChange}} = inputProps;
                        return (
                            <ButtonGroup
                                onPress={onChange}
                ...
                <View>
                    ...
                    <ScrollView style={scrollViewContainerStyle}>
                        <CheckboxContainer name={`${dogId}.performance.${sectionId}.failCodes`}
                                           checkboxes={BuildingSearchInfo.FailCodes}/>
                        <Field name={`Performance.${sectionId}.failCodes`} component={_ =>
                ...
                <View>
                    ...
                    <ScrollView style={scrollViewContainerStyle}>
                        <CheckboxContainer name={`${dogId}.performance.${sectionId}.distractions`}
                                           checkboxes={BuildingSearchInfo.Distractions}/>
                        <Field name={`Performance.${sectionId}.distractions`} component={_ =>
