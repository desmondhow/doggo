...
HEROKU_API_URL = 'https://doggoplatform1.herokuapp.com/';
...
const formatUsersRoute = route =>
  new Promise((res, rej) =>
    getUserID()
      .then(id => res(formatAPILink(`${USERS_ROUTE}/${id}/${route}`)))
      .catch(err => rej(err))
  );
...
export default (routes = {
  ...
  deleteTrainerURL: trainerId =>
    formatUsersRoute(`profile/delete-trainer/${trainerId}`),
